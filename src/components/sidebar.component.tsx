  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col gap-1 p-2 flex-1">
        <SidebarLink to="/stories/" icon={<BookOpenIcon className="size-4" />} collapsed={collapsed}>
          Stories
        </SidebarLink>
        {isDirector && (
          <SidebarLink to="/director" icon={<Cog6ToothIcon className="size-4" />} collapsed={collapsed}>
            Director
          </SidebarLink>
        )}
      </nav>
      ...
      <div className="p-2 border-t border-base-300 flex flex-col gap-1">
        <SidebarLink to="/profile" icon={<UserCircleIcon className="size-4" />} collapsed={collapsed}>
          Profile
        </SidebarLink>
        <button
          onClick={toggle}
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        collapsed && 'justify-center px-0 [&.active]:border-l-0 [&.active]:pl-0',
      )}
    >
      {icon}
      {!collapsed && children}
