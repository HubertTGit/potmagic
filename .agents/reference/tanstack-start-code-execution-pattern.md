---
name: TanStack Start Code Execution Patterns
description: Expert on patterns for controlling where code runs in TanStack Start — server-only, client-only, or isomorphic execution strategies.
model: sonnet
---
