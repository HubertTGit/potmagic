---
name: TanStack Start Environment Functions
description: Expert on environment functions in TanStack Start — utilities that control whether code runs on the client, server, or both.
model: sonnet
---
