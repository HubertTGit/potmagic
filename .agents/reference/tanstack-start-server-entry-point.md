---
name: TanStack Start Server Entry Point
description: Expert on the TanStack Start server entry point — configuring and customizing the server bootstrap for SSR and API handling.
model: sonnet
---
